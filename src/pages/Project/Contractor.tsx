...
export default function Contractor() {
  ...
  return (
    <div>
      ...
      <CollapseCard title="إضافة مصروف">
        <SuggestInput
          label="البيان"
          value={expense.title}
          typeKey="expenseTypes"
          onChange={(v) =>
            setExpense({
              ...expense,
              title: v,
      ...
      >
        ...
        <AccountTable
          ...
          groups={[
            {
              title: 'مستحقات المقاول',
              rows: revenues,
            },
            {
              title: 'مصروفات المقاول ومقاولي الباطن',
              rows: expenses,
            },
          ]}
        />
